...
- [5 Krav til indhold og gevinster ved ‘Advis om sygehusophold’](#krav-til-indhold)
- [6 Forretningsregler for anvendelse af ’Advis om sygehusophold’](#forretningsregler)
  - [6.1 Use cases](#61-use-cases)
  - [6.2 Tekniske specifikationer for ‘Advis om sygehusophold’](#tekniskspecification)
  - [6.3 Eksempel på ‘Advis om sygehusophold’](#eksampel)
...
7. **Hvis der er sket en fejlregistrering, som har udløst et fejlagtigt advis, skal der sendes en rettelse eller en annullering efter følgende principper:**
    1. Hvis der er sendt advis pga. forkert indtastet cpr-nummer eller forkert valg af sygehusophold sendes **en annullering**.

    2. Hvis der er sendt et advis med forkert angivelse af sygehusafdeling eller, forkert tidspunkt for opholdet sendes **en rettelse**, dvs. et nyt korrekt advis, som erstatter tidligere advis. Der skal her ikke sendes en annullering før rettelsen. 
...
### 6.1 Use cases 
Til brug for den tekniske implementering af sygehusadvis findes detaljerede use case beskrivelser, som forbinder indholdsmæssige krav med den forretningsmæssige anvendelse for afsender og modtager af sygehusadvis. Use cases på dindes [forsiden for advis om sygehusophold](../../index.md).
...
<figcaption text-align = "center"><b>Figur 1: Eksempel på, et advis om sygehusophold</b></figcaption>
</figure>
