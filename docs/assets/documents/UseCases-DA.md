...
valideret) meddelelse i Fagsystemets forretningsmæssige indbakke (<a href="#Tabel2" rel="noopener noreferrer"> se forklaring i tabel 2</a>), som præsenteres for brugeraktøren i brugergrænsefladen. Se i øvrigt forklaring under afsnit 1.5 [Termer](#15-Termer) samt
uddybende forklaring i dokumentet "[Generelle tekniske use cases](#14-referencer)".
